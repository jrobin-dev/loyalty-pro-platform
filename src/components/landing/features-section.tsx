            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="relative h-full p-6 md:p-8 rounded-2xl bg-card hover:bg-card/80 transition-all duration-300 border-0 hover:border hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1">
                                {/* Icon */}
